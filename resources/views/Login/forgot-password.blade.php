        ...
        <div class="" style="border-radius: 25px" >
            <div class="card-body login-card-body" style="background-color:#E1F3FF;">
              @if (Session::has("success"))
                  <div class="alert alert-success alert-dismissible show" style="background: rgba(34,187,51, 0.7);font-size:0.9em">
                ...
                <form action="{{ route('forgot-password') }}" method="post" autocomplete="off">
                    @csrf
                              <div class="input-group mb-3">
                                <input type="email" name="email" class="form-control {{$errors->first('email') ? 'is-invalid' : ''}} border1" value="{{ old('email') }}" placeholder="Email">
                              ...
                              <a style="font-family:Poppins;font-size:0.95em;color:gray" href="{{ route('login') }}"><strong>Back to Sign in</strong></a>
                            </div>
                </form>
             <!-- /.login-card-body -->
        </div>
